...
const CategoryItem = ({ icon, title, imageSrc }: Props) => {
  return (
    <HStack
      ...
      align="center"
      className={cn(
        'max-w-fit cursor-pointer rounded-[10px] border border-white/10 px-[17px] py-4 transition-all duration-300 hover:opacity-70 md:min-w-[197.14px] md:px-[20px] md:hover:scale-90',
        !!icon && 'bg-[#12294A]'
      )}
    >
